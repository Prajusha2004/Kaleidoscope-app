  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      const aiResponse: Message = {
        ...
        content: data.response || "I'm here to listen. Can you tell me more about what you're experiencing?",
        isAI: true,
        timestamp: new Date()
      };
            ...
            <CardContent className="p-6">
              ...
              <div className="mt-4 p-3 bg-amber-100/50 rounded-lg border border-amber-200">
                <p className="text-xs text-amber-800">
                  <strong>Privacy & Security:</strong> Your conversations are processed securely through our backend service. This AI companion provides general support and is not a replacement for professional mental health treatment. If you're experiencing a mental health crisis, please contact a mental health professional or emergency services.
                </p>
              </div>
            </CardContent>
          </Card>
